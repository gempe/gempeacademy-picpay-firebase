...
import {
  ON_CREATE_PAYMENTS_INDEXERS,
  ON_DELETE_PAYMENTS_INDEXERS,
  ON_CREATE_TRANSFER_BALANCE_BETWEEN_ACCOUNTS,
} from './payments/payments.functions';
...
export const onCreateTransferBalanceBetweenAccounts: functions.CloudFunction<
